defmodule ElixirAnalyzer.Constants do
  ...
  @constants [
    ...
    gotta_snatch_em_all_add_card_use_mapset_member_and_put: "elixir.gotta-snatch-em-all.add_card_use_mapset_member_and_put",
    ...
    gotta_snatch_em_all_remove_duplicates_use_enum_sort: "elixir.gotta-snatch-em-all.remove_duplicates_use_enum_sort",
    gotta_snatch_em_all_remove_duplicates_do_not_use_enum_uniq: "elixir.gotta-snatch-em-all.remove_duplicates_do_not_use_enum_uniq",
    gotta_snatch_em_all_extra_cards_use_mapset_difference_and_size: "elixir.gotta-snatch-em-all.extra_cards_use_mapset_difference_and_size",
    gotta_snatch_em_all_boring_cards_use_mapset_intersection: "elixir.gotta-snatch-em-all.boring_cards_use_mapset_intersection",
    gotta_snatch_em_all_boring_cards_use_enum_sort: "elixir.gotta-snatch-em-all.boring_cards_use_enum_sort",
    gotta_snatch_em_all_boring_cards_use_enum_reduce: "elixir.gotta-snatch-em-all.boring_cards_use_enum_reduce",
    gotta_snatch_em_all_total_cards_use_mapset_union_and_size: "elixir.gotta-snatch-em-all.total_cards_use_mapset_union_and_size",
    gotta_snatch_em_all_total_cards_use_enum_reduce: "elixir.gotta-snatch-em-all.total_cards_use_enum_reduce",
    gotta_snatch_em_all_split_shiny_cards_use_enum_sort: "elixir.gotta-snatch-em-all.shiny_cards_use_enum_sort",
    gotta_snatch_em_all_split_shiny_cards_use_string_starts_with: "elixir.gotta-snatch-em-all.shiny_cards_use_string_starts_with",
